...
inline juce::String getPluginDescription(const juce::String& pluginName)
{
    ...
    if (!initialized)
    {
        ...
        descriptions["adptr audio utopia"] = "Cutting-edge algorithmic reverb designed for pristine spatial processing and immersive soundscapes. Features advanced early reflections modeling and lush tail algorithms for realistic acoustic spaces. Perfect for everything from intimate rooms to expansive halls with exceptional clarity.";
        descriptions["adptr utopia"] = "Cutting-edge algorithmic reverb designed for pristine spatial processing and immersive soundscapes. Features advanced early reflections modeling and lush tail algorithms for realistic acoustic spaces. Perfect for everything from intimate rooms to expansive halls with exceptional clarity.";
        descriptions["utopia"] = "Cutting-edge algorithmic reverb designed for pristine spatial processing and immersive soundscapes. Features advanced early reflections modeling and lush tail algorithms for realistic acoustic spaces. Perfect for everything from intimate rooms to expansive halls with exceptional clarity.";
